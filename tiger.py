...
def handleStatusCodes(status_code):
	...
	sys.stdout.write("\033[38;5;6m[request-count] \033[37m %i \033[0m" % request_counter)
	print("\033[36mGET: \033[38;5;5m" +str(msg)+ " \033[38;5;4mstatus-code: \033[37m" +str(status_code)+ "\033[0m")
	sys.stdout.flush()
	if status_code == 429:
