...
def handleStatusCodes(status_code):
	...
	sys.stdout.write("\033[38;5;220m[Req]\033[37m %i | " % request_counter)
	print(f"\033[38;5;220mHost: \033[37m| " +str(url)+ " | \033[38;5;220mStatus: \033[37m| " +str(status_code)+ " |\033[0m")
	sys.stdout.flush()
	if status_code == 429:
